...
latex_documents = [
    (master_doc, 'ml_uncertainty.tex', u'pls\\_uncertainty Documentation',
...
man_pages = [
    (master_doc, 'ml_uncertainty', u'ml_uncertainty Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ml_uncertainty', u'ml_uncertainty Documentation',
     author, 'ml_uncertainty', 'One line description of project.',
     'Miscellaneous'),
]
